...
<head>
  <!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-18EKD1M63T"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-18EKD1M63T');
</script>
  <meta charset="UTF-8">
  ...
  <style>
    ...
    .btn {
      background: linear-gradient(90deg,#7c5cff,#3ce6b3);
      color: #0f1220;
      border: none;
      padding: 6px 12px;
      border-radius: 6px;
...
<body>
  ...
  <div class="grid">
    ...
    <div class="card" data-id="video1">
      <video controls>
        <source src="videos/jedit1.mp4" type="video/mp4">
    ...
    <div class="card" data-id="video2">
      <video controls>
        <source src="videos/jedit2.mp4" type="video/mp4">
        Your browser does not support the video tag.
      </video>
      <div class="card-body">
        <h3>codm vs fortnite</h3>
        <p>by jason</p>
        <div class="actions">
          <button class="btn like-btn">👍 Like</button>
        </div>
  ...
  <script>
    document.querySelectorAll('.card').forEach(card => {
      ...
      const viewsSpan = card.querySelector('.views');
      ...
      // Increment views when video plays
